...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PaymentActivity.this,LastActivity.class));
            }
        });
    ...
    public void navigateToBaseActivity(View view) {
        ...
        String email = "jaisuriya060296@gmail.com";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.location_share_menu:
                startActivity(new Intent(PaymentActivity.this,LocationActivity.class));
                break;
